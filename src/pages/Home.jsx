...
useEffect(()=>{
  ...
  return (
  <div>
    <section className="flex flex-col  sm:flex-row justify-between gap-2 items-center py-[16px] lg:mx-[80px] ">
      ...
      <section className="mt-4 flex flex-col md:flex-row items-center justify-between relative py-[16px] lg:mx-[80px] px-[6px]">
         <div className="text-center lg:text-start lg:w-[150%] z-50 ">
      ...
      {/* section 3 */}
      <section>
        <div className="text-center mb-10 px-[6px]">
