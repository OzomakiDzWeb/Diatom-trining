  ...
  return (
    <nav className="flex justify-between items-center py-[16px] lg:mx-[80px] px-[6px] lg:mt-6">
      <div className=" flex justify-between items-center lg:w-[50%]">
         ...
         <div className="hidden sm:flex justify-between ml-4 ">
          <Link to='/wiewe-exist' className="nav-link text-n-bold">{t('Header.link1')}</Link>
          <Link to='/howit-work' className=" nav-link text-n-bold ml-4  ">{t('Header.link2')}</Link>
         </div>
      </div>
        <div className="sm:flex justify-between items-center  hidden">
           ...
           <button onClick={()=>setShowDomendFoem(true)} className=" h-[56px] py-[16px] px-[26px] rounded-[50px] bg-[#F0FF1E] text-n-bold">{t('Header.btn-header')}</button>
        </div>
        <button onClick={()=>setShowDomendFoem(true)} className=" sm:hidden h-[56px] py-[16px] px-[26px] rounded-[50px] bg-[#F0FF1E] text-n-bold">{t('Header.btn-header')}</button>
